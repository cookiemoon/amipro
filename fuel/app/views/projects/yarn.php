...
<div class="container">
    ...
    <div class="main-content-area">
        ...
        <!-- Yarn List -->
        <div class="projects-container" data-bind="foreach: currentPageViewModel().filteredYarns">
        ...
        <div class="empty-state" data-bind="visible: currentPageViewModel().filteredYarns().length === 0">
            <p>毛糸がありません。</p>
            <a href="<?php echo Uri::create('projects/create'); ?>" class="create-project-link">新しい毛糸を追加</a>
        </div>
